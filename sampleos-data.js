window.sampleOSData = {
  ...
  styleList: [
    ...
    { id: "style_305", styleNo: "305", brand: "SUPREME", season: "FW26", styleName: "印花抓绒", category: "抓绒", route: "bonding_xinchangjiang", currentGate: "shipment_decision", samplePhase: "sms", sampleLocation: "业务", currentOwner: ["user_guyonghong", "user_yang"], gateOwner: "user_daqian", finalApprover: "user_yang", plannedShipDate: "2026-07-02", riskStatus: "waiting_exception", nextAction: "提交风险说明并等待例外放行", blockerSummary: "重大问题等待例外放行" },
    { id: "style_395", styleNo: "395", brand: "萨洛蒙", season: "SS27", styleName: "越野背心", category: "背心", route: "normal", currentGate: "preparation_gate", samplePhase: "second_sample", sampleLocation: "工厂", currentOwner: ["user_liweihong", "user_dahong", "user_wangbu"], gateOwner: "user_wangbu", finalApprover: "user_yang", plannedShipDate: "2026-06-29", riskStatus: "overdue", nextAction: "补齐准备资料后由王部长确认", blockerSummary: "面料未到 / 辅料未齐" },
    { id: "style_418", styleNo: "418", brand: "迪桑特", season: "FW26", styleName: "城市雨衣", category: "雨衣", route: "normal", currentGate: "shipment_decision", samplePhase: "qc_sample", sampleLocation: "已寄出", currentOwner: ["user_guyao"], gateOwner: "user_daqian", finalApprover: "user_yang", plannedShipDate: "2026-06-30", riskStatus: "shipped", nextAction: "业务确认寄样记录", blockerSummary: "无阻塞问题" },
  ],
  samples: [
    { id: "sample_212_1", styleId: "style_212", samplePhase: "first_sample", versionName: "一次样", status: "shipped", location: "客户", holder: "顾瑶", createdAt: "2026-06-18 10:00", updatedAt: "2026-06-18 17:20", imageList: ["正面", "背面"], videoList: [], reviewId: "review_212_first", plannedShipDate: "2026-06-18" },
    { id: "sample_212_2", styleId: "style_212", samplePhase: "second_sample", versionName: "二次样", status: "reviewing", location: "开发车间", holder: "李师傅", createdAt: "2026-06-28 10:30", updatedAt: "2026-06-28 11:10", imageList: ["正面", "背面", "领口 / 帽口", "袖口", "下摆抽绳", "压胶缝", "口袋"], videoList: ["整体视频 00:32"], reviewId: "review_212_second", plannedShipDate: "2026-06-28" },
    { id: "sample_305_sms", styleId: "style_305", samplePhase: "sms", versionName: "销售样", status: "shipment_decision", location: "业务", holder: "顾永宏", createdAt: "2026-06-27 14:20", updatedAt: "2026-06-29 09:00", imageList: ["正面", "背面"], videoList: [], reviewId: "review_305_sms", plannedShipDate: "2026-07-02" },
    { id: "sample_395_2", styleId: "style_395", samplePhase: "second_sample", versionName: "二次样", status: "preparation_blocked", location: "工厂", holder: "李卫红", createdAt: "2026-06-20 09:00", updatedAt: "2026-06-29 08:30", imageList: [], videoList: [], reviewId: "review_395_second", plannedShipDate: "2026-06-29" },
    { id: "sample_418_qc", styleId: "style_418", samplePhase: "qc_sample", versionName: "品质样", status: "shipped", location: "已寄出", holder: "业务", createdAt: "2026-06-26 11:00", updatedAt: "2026-06-30 16:00", imageList: ["正面"], videoList: [], reviewId: "review_418_qc", plannedShipDate: "2026-06-30" },
  ],
  reviews: [
    ...
    { id: "review_305_sms", styleId: "style_305", sampleId: "sample_305_sms", reviewNo: "SR-305-SMS", status: "shipment_decision", gateOwner: "user_daqian", finalApprover: "user_yang", issueIds: ["issue_print"], finalDecision: "exception_release", exceptionRequest: { reason: "客户会议", riskNote: "印花轻微偏位，业务需带说明寄样。", applicant: "user_guyonghong", approver: "user_yang", customerNotified: false, approvalStatus: "待审批" }, timeline: [], departmentReviews: [] },
    { id: "review_395_second", styleId: "style_395", sampleId: "sample_395_2", reviewNo: "SR-395-PREP", status: "not_started", gateOwner: "user_wangbu", finalApprover: "user_yang", issueIds: [], finalDecision: "none", exceptionRequest: null, timeline: [], departmentReviews: [] },
    { id: "review_418_qc", styleId: "style_418", sampleId: "sample_418_qc", reviewNo: "SR-418-QC", status: "completed", gateOwner: "user_daqian", finalApprover: "user_yang", issueIds: [], finalDecision: "can_ship", exceptionRequest: null, timeline: [], departmentReviews: [] },
  ],
  issues: [
    ...
    { id: "issue_print", styleId: "style_305", sampleId: "sample_305_sms", reviewId: "review_305_sms", title: "印花位置偏差", description: "客户会议前需带说明寄样。", sourceDepartment: "业务部", relatedArea: "前片印花", level: "major", shipmentBlocking: true, canShipWithNote: true, owner: "user_guyonghong", dueDate: "2026-07-02 10:00", status: "in_progress", verifier: "user_daqian", evidence: "图片证据", createdAt: "2026-06-29 09:10", updatedAt: "2026-06-29 09:10" },
  ],
};
